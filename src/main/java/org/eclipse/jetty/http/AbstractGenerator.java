...
public abstract class AbstractGenerator implements Generator
{
    ...
    protected int _status = 0; //状态码
    protected int _version = HttpVersions.HTTP_1_1_ORDINAL; //http版本
    protected  Buffer _reason; //状态的解释
    protected  Buffer _method; //请求方法
    protected  String _uri; //资源路径

    protected long _contentWritten = 0;
    protected long _contentLength = HttpTokens.UNKNOWN_CONTENT; //内容长度
    ...
    /* ------------------------------------------------------------ */
    //空闲就是没有设置方法和状态码，所以reset的时候也需要恢复为这个状态
